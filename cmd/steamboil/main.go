...
import (
	...
	"github.com/lacsar712/bakoven/internal/web"
	"github.com/lacsar712/bakoven/internal/web/api"
)
...
func main() {
	...
	go func() {
		log.Printf("bakoven listening on %s (unit %s)", cfg.ListenAddr, application.UnitID())
