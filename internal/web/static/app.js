...
function renderSnapshot(snap) {
  ...
  document.getElementById("pressure").textContent = snap.ovenline.steam_pressure_psi.toFixed(0);
  document.getElementById("mw").textContent = snap.ovenline.output_mw.toFixed(1);
  document.getElementById("tray-level").textContent = snap.tray.level_percent.toFixed(1);
  ...
  trendData.push(snap.ovenline.steam_pressure_psi);
...
document.getElementById("btn-proof").addEventListener("click", () => postAction("/proof/start?holder=hmi"));
document.getElementById("btn-proof-done").addEventListener("click", () => postAction("/proof/complete?holder=hmi"));
